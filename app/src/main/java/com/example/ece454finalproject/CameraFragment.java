...
public class CameraFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d(TAG, "Failed to initialize image classifier");
        }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            Log.d(TAG,"Camera2 API not supported on this device");
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Log.d(TAG, "ERROR: Camera permissions not granted");
            }
        } else {
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            ...
            Log.d("Camera2", "Couldn't find any suitable preview size");
            return choices[0];
        }
    }
    ...
    private void classifyFrame() {
        Bitmap bitmap = mTextureView.getBitmap(224,224); //not sure about size
